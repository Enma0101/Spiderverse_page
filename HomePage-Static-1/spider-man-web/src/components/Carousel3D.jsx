...
// ─────────────────────────────────────────────────────────
function ModelInstance({ offset, angleRef, isPausedRef, url, gameData, onSelect, setGlobalHover }) {
    ...
    // Legacy states maintained for backwards compatibility if needed
    ...
    useFrame((_state, delta) => {
        ...
        if (groupRef.current) {
            // Apply scale logic below in the main useFrame
        }
    ...
    return (
        <group
            ...
            onPointerEnter={(e) => {
                ...
                e.stopPropagation();
                setHovered(true);
                if (setGlobalHover) setGlobalHover(true);
            }}
            onPointerLeave={(e) => {
...
// ─────────────────────────────────────────────────────────
// CanvasLoader: Indicador de carga para los modelos 3D
// ─────────────────────────────────────────────────────────
